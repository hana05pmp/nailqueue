...
import { callNext, completeService, joinQueue, nowServing, serviceName, skipTicket, startService, useSalonState, waitingTickets, staffLogout } from "@/lib/salon/store";
...
function DashboardPage() {
  ...
  return <StaffGuard><PageShell title="Staff dashboard" subtitle="Manage today's live nail salon queue.">
